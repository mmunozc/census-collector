...
const StartConection = async () => {
    mainJson = await readLocalJsonFile("dwellings.json");
}
...
const ValidateUser = async (user) => {
    const data = await readLocalJsonFile("dwellings.json");
    //console.log("data.hasOwnProperty(user)", data.hasOwnProperty(user));
